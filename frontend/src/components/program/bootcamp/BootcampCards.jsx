  ...
  const domains = [
    {
      ...
      description: "Unlock the power of Python and build dynamic web applications from front to back. Our Python Full Stack Development bootcamp offers a comprehensive journey into modern web technologies, equipping you with the skills to design, develop, and deploy robust solutions. Dive deep into frameworks like Django and Flask, master essential frontend technologies, and emerge as a proficient full-stack developer ready for the industry.",
      image: pythonImage,
      organization: "",
    },
    {
    ...
    },
    {
    ...
    },
     {
      ...
      description: "Step into the future with our Internet of Things bootcamp! Explore the fascinating world where physical objects connect and communicate, transforming industries. Learn to design, develop, and deploy smart solutions using popular IoT platforms, sensors, and microcontrollers. Gain practical skills in hardware-software integration, data collection, and cloud connectivity, positioning yourself at the forefront of the IoT revolution.",
      image: iotImage,
      organization: "",
    },
    {
    ...
    },
    {
      ...
      description: "Become a digital guardian with our Cyber Security bootcamp! Learn to defend against evolving cyber threats, protect critical data, and ensure system integrity. Gain hands-on experience in ethical hacking, vulnerability assessment, network security, and incident response, equipping you with the vital skills to safeguard the digital world.",
      image: cyberImage,
      organization: "",
    },
  ];
...
const handleApplyClick = (domain) =>
  navigate("/program/bootcampregister", {
    state: {
  ...
  const renderPopupComponent = () => {
    ...
    return Component ? (
      <Component handleClose={() => setPopupDomain(null)} />
    ) : null;
  };
  ...
  return (
    <div>
      ...
      <div className="relative flex flex-col md:flex-row items-center justify-between px-29 py-18 ">
        <div className="w-full md:w-1/2 flex flex-col gap-6">
          <h1 className="text-3xl md:text-5xl text-center md:text-center text-white">
            Master Skills with Our Bootcamp Programs
          </h1>
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
            {[
              { title: "Expert Trainers", desc: "Learn from experienced professionals." },
              { title: "Intensive Training", desc: "Fast-paced, hands-on learning approach." },
              { title: "Career Guidance", desc: "Resume tips & job interview preparation." },
              { title: "Flexible Schedules", desc: "Choose online or offline learning modes." },
            ].map((item, index) => (
              <li
                key={index}
      ...
      <h2
        ...
        ref={cardsRef}
      >
        Accelerate Your Career with Bootcamps
      </h2>
...
>
  Apply
      ...
      <Dialog
        open={!!popupDomain}
        onOpenChange={(open) => !open && setPopupDomain(null)}
      >
